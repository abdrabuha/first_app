...
|---|---|---|
| اللغة | عربي فقط | **عربي ⇄ English بضغطة زر** مع RTL/LTR تلقائي |
| الدرس | نص طويل بدون تنسيق | **بطاقات + جدول** منسّق وسهل القراءة |
| الاختبار | لا يوجد | **4 أسئلة تفاعلية** مع تصحيح فوري وشرح |
| حاسبة الدرجات | بايثون فقط (طرفية) | **جافاسكريبت تفاعلية في المتصفح** + عرض كود بايثون المقابل |
| الملفات المؤقتة | `abdrabuh.html` و `.DS_Store` | **حُذفت** (نظافة المستودع) |
...
start index.html
```
> 💡 **نصيحة:** فعّل **GitHub Pages** من إعدادات المستودع (Settings ▸ Pages ▸ Deploy from branch ▸ `first-branch` / root) ليصبح التطبيق موقعاً مباشراً برابط عام مجاني.
